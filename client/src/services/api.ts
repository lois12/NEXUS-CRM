...
export const registrationsApi = {
  ...
  createAdminSubmission: (regId: string, data: { contactName: string; contactEmail?: string; contactPhone?: string; answers?: Record<string, string>; sendEmail?: boolean }): Promise<ApiResponse<any>> =>
